const questions = [
  ...
  {
    question: "Các đường dưới trong biểu diễn sơ đồ UML, (i) là đáp án nào sau đây",
    options: [
      // Các lựa chọn gốc không được cung cấp nếu câu hỏi thiếu hình ảnh
    ],
    answer: "Cần hình ảnh sơ đồ UML"
  },
  {
  ...
  {
    question: "Cho sơ đồ lớp sau. Sơ đồ trên đúng hay sai?",
    options: [
        // Các lựa chọn gốc không được cung cấp nếu câu hỏi thiếu hình ảnh
    ],
    answer: "Cần hình ảnh sơ đồ lớp"
  },
  {
  ...
  {
    question: "Cho mô tả như sau. Từ mô tả ta có thể biết được:",
    options: [
        // Các lựa chọn gốc không được cung cấp nếu câu hỏi thiếu hình ảnh
    ],
    answer: "Cần hình ảnh mô tả"
  },
  {
  ...
  {
    question: "Cho sơ đồ sau. Phát biểu nào sau đây là chính xác?",
    options: [
        // Các lựa chọn gốc không được cung cấp nếu câu hỏi thiếu hình ảnh
    ],
    answer: "Cần hình ảnh sơ đồ"
  },
  {
  ...
  {
    question: "Cho sơ đồ sau. Phát biểu nào sau đây là đúng?",
    options: [
    ...
    answer: "Cần hình ảnh sơ đồ" // Đáp án phụ thuộc vào sơ đồ không được cung cấp
  },
  {
  ...
  {
    question: "Trong sơ đồ sau, tác nhân nào có thể gọi use case H?",
    options: [
      "A. C, I",
      "B. A,D",
      "C. A, B, C",
      "F. A, B, C, D, E" // Lưu ý: Thứ tự nhảy từ C sang F trong câu hỏi gốc
    ],
    answer: "Cần hình ảnh sơ đồ" // Đáp án phụ thuộc vào sơ đồ không được cung cấp
  },
  {
  ...
  {
    question: "Các khái niệm nào được thể hiện trong sơ đồ lớp sau:",
    options: [
    ...
    answer: "Cần hình ảnh sơ đồ lớp" // Đáp án phụ thuộc vào sơ đồ không được cung cấp
  },
  {
    question: "Cho sơ đồ lớp sau: Phát biểu nào sau đây là đúng?",
    options: [
  ...
  {
    question: "Biểu diễn các tác nhân như sau, phát biểu nào sau đây đúng?",
    options: [
    ...
    answer: "Cần hình ảnh biểu diễn tác nhân" // Đáp án phụ thuộc vào sơ đồ không được cung cấp
  },
  {
